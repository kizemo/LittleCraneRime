...
VIAddVersionKey /LANG=2052 "FileDescription" "小鹤輸入法"
...
LangString DISPLAYNAME ${LANG_TRADCHINESE} "小鶴輸入法"
LangString LNKFORMANUAL ${LANG_TRADCHINESE} "【小鶴】說明書"
LangString LNKFORSETTING ${LANG_TRADCHINESE} "【小鶴】輸入法設定"
LangString LNKFORDICT ${LANG_TRADCHINESE} "【小鶴】用戶詞典管理"
LangString LNKFORSYNC ${LANG_TRADCHINESE} "【小鶴】用戶資料同步"
LangString LNKFORDEPLOY ${LANG_TRADCHINESE} "【小鶴】重新部署"
LangString LNKFORSERVER ${LANG_TRADCHINESE} "小鶴算法服務"
LangString LNKFORUSERFOLDER ${LANG_TRADCHINESE} "【小鶴】用戶文件夾"
LangString LNKFORAPPFOLDER ${LANG_TRADCHINESE} "【小鶴】程序文件夾"
LangString LNKFORUPDATER ${LANG_TRADCHINESE} "【小鶴】檢查新版本"
LangString LNKFORSETUP ${LANG_TRADCHINESE} "【小鶴】安裝選項"
LangString LNKFORUNINSTALL ${LANG_TRADCHINESE} "卸載小鶴"
LangString CONFIRMATION ${LANG_TRADCHINESE} "安裝前，請先卸載舊版本的小鶴。$\n$\n按下「確定」移除舊版本，按下「取消」放棄本次安裝。"
...
LangString DISPLAYNAME ${LANG_SIMPCHINESE} "小鹤输入法"
LangString LNKFORMANUAL ${LANG_SIMPCHINESE} "【小鹤】说明书"
LangString LNKFORSETTING ${LANG_SIMPCHINESE} "【小鹤】输入法设定"
LangString LNKFORDICT ${LANG_SIMPCHINESE} "【小鹤】用户词典管理"
LangString LNKFORSYNC ${LANG_SIMPCHINESE} "【小鹤】用户资料同步"
LangString LNKFORDEPLOY ${LANG_SIMPCHINESE} "【小鹤】重新部署"
LangString LNKFORSERVER ${LANG_SIMPCHINESE} "小鹤算法服务"
LangString LNKFORUSERFOLDER ${LANG_SIMPCHINESE} "【小鹤】用户文件夹"
LangString LNKFORAPPFOLDER ${LANG_SIMPCHINESE} "【小鹤】程序文件夹"
LangString LNKFORUPDATER ${LANG_SIMPCHINESE} "【小鹤】检查新版本"
LangString LNKFORSETUP ${LANG_SIMPCHINESE} "【小鹤】安装选项"
LangString LNKFORUNINSTALL ${LANG_SIMPCHINESE} "卸载小鹤"
LangString CONFIRMATION ${LANG_SIMPCHINESE} '安装前，请先卸载旧版本的小鹤。$\n$\n点击 "确定" 移除旧版本，或点击 "取消" 放弃本次安装。'
