...
class WeaselPanel
 ...
 public:
  ...
  MESSAGE_HANDLER(WM_RBUTTONDOWN, OnRightClickedDown)
  MESSAGE_HANDLER(WM_RBUTTONUP, OnRightClickedUp)
  MESSAGE_HANDLER(WM_CONTEXTMENU, OnContextMenu)
  MESSAGE_HANDLER(WM_WEASEL_UI_DELETE_PROMPT, OnDeletePromptMessage)
  ...
  LRESULT OnLeftClickedDown(UINT uMsg,
                            ...
                            LPARAM lParam,
                            BOOL& bHandled);
  LRESULT OnRightClickedDown(UINT uMsg,
                             WPARAM wParam,
                             LPARAM lParam,
                             BOOL& bHandled);
  ...
  LRESULT OnContextMenu(UINT uMsg,
                        ...
                        LPARAM lParam,
                        BOOL& bHandled);
  LRESULT OnDeletePromptMessage(UINT uMsg,
                                WPARAM wParam,
                                LPARAM lParam,
                                BOOL& bHandled);
  int HitTestCandidateIndex(CPoint point);
  void DeleteCandidateAt(int index);
  void DeleteCandidateAtPoint(CPoint client_point);
