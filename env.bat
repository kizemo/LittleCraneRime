...
set DEVTOOLS_PATH=%ProgramFiles%\Git\cmd;%ProgramFiles%\Git\usr\bin;



rem Bundled Rime input schemas (plum recipe). Default: 雾凇拼音 rime-ice

set WEASEL_BUNDLED_RECIPES=iDvel/rime-ice:others/recipes/full
