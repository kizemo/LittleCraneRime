...
class CCandidateList : public ITfIntegratableCandidateListUIElement,
 ...
 public:
  ...
  void _UpdateUIImpl(const weasel::Context& ctx, const weasel::Status& status);
  ...
  size_t GetHighlightedIndex() const;
 ...
 private:
  ...
  BOOL _pbShow;
  bool _ui_element_started = false;
  weasel::UIStyle _style;

  com_ptr<ITfContext> _pContextDocument;

  void _InstallMouseHook();
  void _UninstallMouseHook();
};
